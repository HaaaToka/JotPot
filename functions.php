...
function xss_check_2($data)
{
    ...
    // <,>,"-> $lt,&quot,&gt --- ENT_QUOTES for the ' -> &apos
...
{
   // after php5, this was deleted
    return mysql_real_escape_string($data);
    
}

function sqli_check_3($conn, $data)
{
    #return escape_string($data);
    return mysqli_real_escape_string($conn, $data);
    #look connection.php for pdo realescapestring solution
...
#blacklist
function file_upload_check_1($file, $file_extensions  = array("asp", "aspx", "dll", "exe", "jsp", "php"), $directory = "media/img")
{
...
#whitelist
function file_upload_check_2($file, $file_extensions  = array("jpeg", "jpg", "png", "gif"), $directory = "media/img")
{
